...
public abstract class UsbSerialController {
	...
	public UsbSerialController(UsbManager usbManager,
			UsbDevice usbDevice,
			Resources appResources) throws UsbControllerException {
		if (!isInUsbDeviceFilter(usbDevice, appResources)) {
	...
	protected static boolean isInUsbDeviceFilter(UsbDevice d, Resources appResources) {
		...
		parser = appResources.getXml(me.guillaumin.android.osmtracker.R.xml.usb_device_filter);
		try {
