...
public final class GpsSatellite {
    ...
    void setStatus(android.location.GpsSatellite satellite) {
    	mValid = true;
        mHasEphemeris = satellite.hasEphemeris();
        mHasAlmanac = satellite.hasAlmanac();
        mUsedInFix = satellite.usedInFix();
        mSnr = satellite.getSnr();
        mElevation = satellite.getElevation();
        mAzimuth = satellite.getAzimuth();
    }
